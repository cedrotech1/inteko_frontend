  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        } else if (role === 'province_leader' || role === 'district_leader' || role === 'sector_leader' || role === 'cell_leader' || role === 'village_leader') {
          await navigate('../post');
        }
      } else {
        ...
        <div className="container position-relative">
          <div className="row gy-5" data-aos="fade-in">
            ...
            <div className="col-lg-5 order-2 order-lg-1  flex-column justify-content-center  text-lg-start loginForm">
              ...
              <form onSubmit={handleSubmit} className="myform">
                ...
                <div className="form-group mt-3">
                  ...
                  <input type="text" className="form-control" name="email" style={{ border: '1px solid green', backgroundColor: 'white', color: 'green',outline: 'none' }}   id="email" placeholder="********@gmail.com" onChange={handleChange}/>
                </div>
                <br />
                ...
                <div className="text-center">
                  <button type="submit" style={{ border: '1px solid green', backgroundColor: 'lightblue', color: 'green',margonTop:'0cm' }} className={`form-control ${loading ? 'loading' : ''}`} disabled={loading}>
            ...
            <div className="col-lg-5 order-1 order-lg-2 d-flex align-items-center justify-content-center loginImg">
              <img src={Image}  style={{borderRadius:'0.5cm',margin:'0.5cm'}} className="img-fluid loginImg" alt="" data-aos="zoom-out" data-aos-delay="100" />
            </div>
